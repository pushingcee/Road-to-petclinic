...
```
Theory: Java is an Object orientated language, in Java any and every logic is contained within a:
1. _Methods_ - it's logic that can be executed within our program and they are contained within (the Main)
1. _Classes_ - it's a larger container for interconnected logic, it can also contain variables and constants(the main(String[] args)
